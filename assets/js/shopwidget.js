        ...
        jQuery('#whatsapp_chat_widget').append(`
            <div class='wa-chat-box'>
                <div class='wa-chat-box-header'>
                    <img class='wa-chat-box-brand' onError='this.src= "assets/img/logo.png";' src='${option.brandSetting.brandImg}'/>
                ...
                <div class='wa-chat-box-send'>
                    ...
                    <div class='wa-chat-box-poweredby'>Powered by <a href="#" target="_blank" style="color: #006eff6e;">T & D Creative Indonesia</a></div>
                </div>
            </div>
        `);
